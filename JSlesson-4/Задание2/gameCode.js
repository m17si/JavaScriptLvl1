...
var question = +prompt('Хотите посмотреть ваш ответ?Просто укажите номер вопрос');
if (question > 3 || question < 1) {
  alert('Вы не отвечали на вопрос под этим номером. Хорошего дня!');
}
else {
  switch (question) {
